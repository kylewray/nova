...
nova: mdp_algorithms_cpu.o mdp_algorithms_gpu.o mdp_utilities_gpu.o pomdp_algorithms_cpu.o pomdp_utilities_cpu.o pomdp_algorithms_gpu.o pomdp_utilities_gpu.o
	mkdir -p lib
